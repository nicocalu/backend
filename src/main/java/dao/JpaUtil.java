 ...
 * l'unité de persistance (PERSISTENCE_UNIT_NAME) doit Ãªtre conforme à la
...
public class JpaUtil {
     ...
     * Ã€ utiliser avant la méthode <code>creerFabriquePersistance()</code> pour
     ...
     * <br><strong>Ã€ utiliser uniquement au début de la méthode main() [projet
     * Java Application] ou dans la méthode init() de la Servlet ContrÃ´leur
     ...
     * <br><strong>Ã€ utiliser uniquement à la fin de la méthode main() [projet
     * Java Application] ou dans la méthode destroy() de la Servlet ContrÃ´leur
     * (ActionServlet) [projet Web Application].</strong>
     */
